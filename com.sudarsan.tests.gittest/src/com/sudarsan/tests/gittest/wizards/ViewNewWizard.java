package com.sudarsan.tests.gittest.wizards;
...
public class ViewNewWizard extends Wizard implements INewWizard {
	...
	private void throwCoreException(String message) throws CoreException {
		IStatus status =
			new Status(IStatus.ERROR, "com.sudarsan.tests.gittest", IStatus.OK, message, null);
